--TASK-08 Триггера или процедуры для ведения таблицы истории остатков.

-- trigger to change ware stocks history when stataus of document (sale) is changed ('new' or 'done')

CREATE OR REPLACE TRIGGER t_sale_state_ware_rest_hist_change_update
